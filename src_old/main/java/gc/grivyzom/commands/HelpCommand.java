...
public class HelpCommand {
    ...
    private void initializeHelpEntries() {
        helpEntries.add(new HelpEntry(
                "/rtp",
                "Teletransporte aleatorio seguro a una ubicación dentro del rango",
                "grvrtp.use"
        ));
        ...
        helpEntries.add(new HelpEntry(
                "/rtp <jugador>",
                "Teletransporta a otro jugador aleatoriamente de forma segura",
                "grvrtp.use.others"
        ));
        ...
        helpEntries.add(new HelpEntry(
                "/rtp <rango> <mundo>",
                "Teletransporte aleatorio seguro en un mundo específico",
                "grvrtp.use"
        ));
        ...
        helpEntries.add(new HelpEntry(
                "/grvrtp reload",
                "Recarga la configuración del plugin y sistema de seguridad",
                "grvrtp.admin"
        ));

        helpEntries.add(new HelpEntry(
                "/grvrtp safety",
                "Muestra la configuración actual del sistema de seguridad",
                "grvrtp.admin"
        ));
    ...
    public void showHelp(CommandSender sender, int page) {
        ...
        sender.sendMessage("§7Sistema de seguridad: §aActivo §7- Evita spawns peligrosos");
        sender.sendMessage("");
